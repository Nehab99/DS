...
def display_results(results):
    ...
    df = pd.DataFrame(results, columns=["Configuration", "Precision"])
    print(df)
...
def train_and_evaluate(train_file, model_file, test_file, configurations):
    ...
    for config in configurations:
        ...
        # Evaluate the model
        precision = evaluate_model(model_file, test_file)
        results.append([config['name'], precision])
...
def main():
    # File paths
    input_data = "/Users/drish/Documents/GitHub/project/data/movie_review.csv"  # Update this to your dataset path
    processed_data = "/Users/drish/Documents/GitHub/project/data/processed_movie_reviews.txt"
    fasttext_data = "/Users/drish/Documents/GitHub/project/data/fasttext_movie_reviews.txt"
    model_file = "/Users/drish/Documents/GitHub/project/data/movie_reviews_model.bin"
    test_data = "/Users/drish/Documents/GitHub/project/data/test_movie_reviews.txt"
